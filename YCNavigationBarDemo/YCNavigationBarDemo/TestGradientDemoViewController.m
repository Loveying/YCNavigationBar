//
//  TestGradientDemoViewController.m
//  XYNavigationBarDemo
//
...
@interface TestGradientDemoViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation TestGradientDemoViewController {
...
- (void)viewDidLoad {
    ...
    self.yc_barAlpha = 0.0;
    self.yc_barStyle = UIBarStyleBlack;
    self.yc_tintColor = UIColor.whiteColor;
    self.yc_titleTextAttributes = @{ NSForegroundColorAttributeName: [UIColor.whiteColor colorWithAlphaComponent:0.0] };
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    vc.yc_barStyle = UIBarStyleBlack;
    vc.yc_barTintColor = [UIColor purpleColor];
...
- (void) scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (gradientProgress != _gradientProgress) {
        ...
        if (_gradientProgress < 0.1) {
            self.yc_barStyle = UIBarStyleBlack;
            self.yc_tintColor = UIColor.whiteColor;
            self.yc_titleTextAttributes = @{ NSForegroundColorAttributeName: [UIColor.blackColor colorWithAlphaComponent:0] };
        } else {
            self.yc_barStyle = UIBarStyleDefault;
            self.yc_tintColor = UIColor.blackColor;
            self.yc_titleTextAttributes = @{ NSForegroundColorAttributeName: [UIColor.blackColor colorWithAlphaComponent:_gradientProgress] };
        }
        
        self.yc_barAlpha = _gradientProgress;
        [self yc_setNeedsUpdateNavigationBar];
    }
